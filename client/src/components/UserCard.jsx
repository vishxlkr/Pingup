      ...
      >
         ...
         <div className="flex mt-4 gap-2">
            ...
            <button
               ...
               className="w-full py-2 rounded-md flex justify-center items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 active:sc95 transition text-white cursor-pointer"
            >
            ...
            {/* connnection request button / message button */}
            <button
            ...
            >
               {currentUser?.connections.includes(user._id) ? (
                  <MessageCircle className="w-5 h-5 group-hover:scale-120 transition " />
               ) : (
                  <Plus className="w-5 h-5 group-hover:scale-150 transition" />
               )}
            </button>
         </div>
      </div>
