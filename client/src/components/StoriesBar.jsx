         ...
         <div className="flex gap-4 pb-5">
            ...
            {stories.map((story, index) => (
               <div
                  ...
                  key={index}
                  className="relative rounded-lg shadow min-w-30 max-w-30 max-h-40 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b from bg-indigo-500 to-purple-600 hover:from-indigo-700 hover:to-purple-800 active:scale-95"
               >
                  <img
                  ...
                  {story.media_type !== "text" && (
                     <div className="absolute inset-0 z-1 rounded-lg bg-black overflow-hidden">
                        {stories.media_type === "image" ? (
                           ...
                           <video
                              src={story.media_url}
                              className="h-full w-full object-cover hover:scale-110 transitio duration-500 opacity-70 hover:opacity-80"
                           />
                        )}
                     </div>
                  )}
